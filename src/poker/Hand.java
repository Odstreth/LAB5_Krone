...
public class Hand{
	...
	@Id
	@javax.persistence.GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_HANDS")
	@javax.persistence.SequenceGenerator(name = "SEQ_HANDS", sequenceName = "SEQ_HANDS", allocationSize = 1)
	@Column(name = "id")
	private int id;
